...
const footerLinks = {
  Platform: [
    ...
    { label: 'Verified Profiles', href: '#features' },
...
export function Footer() {
  ...
  return (
    <footer className="border-t border-border/60" style={{ background: '#2C1810' }}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-10 pt-16 pb-10">
        ...
        <div           className="grid grid-cols-2 md:grid-cols-5 gap-6 sm:gap-10 mb-14">
          ...
          >
            <div className="flex items-center gap-2.5 mb-5">
              <div className="w-8 h-8 rounded-full gradient-maroon flex items-center justify-center">
            ...
            <p className="text-sm leading-relaxed" style={{ color: 'rgba(250,247,242,0.75)' }}>
              Where souls find each other. India&apos;s most trusted AI-powered matrimonial platform — since 2018.
            </p>
              ...
              <ul className="space-y-3">
                {links.map((link) => (
                  <li key={link.label}>
                    <Link
                      href={link.href}
                      className="text-sm transition-colors hover:text-[#E8907A]"
        ...
        >
          ...
          <p className="text-xs flex items-center gap-1.5" style={{ color: 'rgba(250,247,242,0.60)' }}>
            Made with care for
            <svg className="w-3 h-3 fill-[#C1533A]" viewBox="0 0 16 16">
